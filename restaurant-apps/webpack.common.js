    ...
    new WorkboxWebpackPlugin.GenerateSW({
      ...
      runtimeCaching: [
        ...
        },
        {
          ...
          handler: 'StaleWhileRevalidate',
          options: {
            cacheName: 'restaurantdb-list-api',
          },
        },
        {
          urlPattern: ({ url }) => url.href.startsWith('https://restaurant-api.dicoding.dev/detail/:id'),
          handler: 'StaleWhileRevalidate',
          options: {
        ...
        },
        {
          ...
          handler: 'StaleWhileRevalidate',
          options: {
            cacheName: 'restaurantdb-review-api',
          },
        },
        {
          ...
          handler: 'StaleWhileRevalidate',
          options: {
            cacheName: 'restaurantdb-image-small-api',
          },
        },
        {
          ...
          handler: 'StaleWhileRevalidate',
          options: {
            cacheName: 'restaurantdb-image-medium-api',
          },
        },
        {
          ...
          handler: 'StaleWhileRevalidate',
          options: {
            cacheName: 'restaurantdb-image-large-api',
          },
        },
      ],
    }),
